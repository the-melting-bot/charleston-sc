...
const featuredParks = [
  {
    ...
    amenities: ["Restrooms", "Picnic Area", "Fishing"],
  ...
  },
  {
    ...
    slug: "hampton-park",
    neighborhood: "Peninsula",
    amenities: ["Picnic Area", "Dog Park"],
  ...
  },
  {
    ...
    amenities: ["Playground", "Dog Park", "Fishing", "Disc Golf"],
    image: "/images/parks/james-island-county-park.jpg",
  },
  {
    name: "Brittlebank Park",
    slug: "brittlebank-park",
    neighborhood: "Peninsula",
    amenities: ["Picnic Area", "Playground", "Fishing"],
    image: "/images/parks/brittlebank-park.jpg",
  },
  {
    name: "Palmetto Islands County Park",
    slug: "palmetto-islands-county-park",
    neighborhood: "Mount Pleasant",
    amenities: ["Playground", "Nature Trail", "Kayaking"],
    image: "/images/parks/palmetto-islands-county-park.jpg",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex gap-5 overflow-x-auto pb-4 snap-x snap-mandatory sm:grid sm:grid-cols-2 sm:overflow-visible sm:pb-0 lg:grid-cols-3">
          {featuredParks.map((park, index) => (
            <FadeIn key={park.slug} delay={index * 100} className="min-w-[280px] flex-shrink-0 snap-start sm:min-w-0">
